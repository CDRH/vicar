...
*/
	public static int writeFileFromInputStream(String the_filename,InputStream the_sis){
		int byteswritten = 0;
		try {
			FileOutputStream fos = new FileOutputStream("/tmp/upload/"+the_filename);
...
*/
	public static int writeImageFileFromInputStream(String the_filename,InputStream the_sis){
		int byteswritten = 0;
		try {
			FileOutputStream fos = new FileOutputStream("/tmp/upload/"+the_filename);
			BufferedInputStream bis = new BufferedInputStream(the_sis,BUFFER);
