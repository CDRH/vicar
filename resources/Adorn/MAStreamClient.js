//SAVE BUTTON
var baseurl = 'MAStreamServer.xml';
var msgbox;
var msgline;
var msgline1;
var contentlen = 0;
...
var donebutton;
	...
	function MAClientInit(dir,macorpus,mausechoice){
		...
		contentlen = 0;
		var url = baseurl+'?dir='+dir+'&macorpus='+macorpus+'&mausechoice='+mausechoice;//+'&act=test';
		HTTP.doGet(url);
	}
