package edu.unl.abbot.vicar.UploadFiles;
...
* UploadServer gives an XML response containing the number of bytes written so that AjaxUpload.js can calculate percent uploaded and control a progress bar's appearance.
*
...
public class UploadServer extends ServiceableGenerator implements Disposable {
...
@Override
	public void setup(SourceResolver resolver, Map objectModel,String src, Parameters par) {
		System.out.println("UploadServer.java setup");
		...
		m_complete = 0;
	System.out.println("DIR<"+m_dirname+">");
		//String destdir = Global.BASE_USER_DIR+"/"+m_OwnerPath+"/"+m_dirname;
		//String destdir = "/Users/franksmutniak/Desktop/tmp";
		String destdir = Global.BASE_USER_DIR+"/tmp";
		System.out.println("UploadServer DESTDIR<"+destdir+">");
		if(m_filename!=null){
...
*/
	public void generateResponseXML(ContentHandler contentHandler,String the_dirname,int the_complete,String the_filename,int the_size,String the_msg) throws SAXException, ProcessingException {
		try {
			/**
			<Response dirname="dir" complete="1">
				<Msg filename="myfile.xml" filesize="333">msg</Msg>
			</Response>
			**/
			...
			System.out.println("RESPONSE dirname<"+the_dirname+"> complete<"+the_complete+">");
			...
			if(the_msg!=null){
				...
				System.out.println("\t MSG filename<"+the_filename+"> filesize<"+the_size+">");
				System.out.println("\t\t ["+the_msg+"]");
			...
			System.out.println("UploadServer ERROR");
			e.printStackTrace();
		}
	}
