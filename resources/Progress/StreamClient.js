...
var donebutton;
	...
	function ClientInit(dir,conv,abbotns,abbotcustom){
		...
		contentlen = 0;
		var url = baseurl+'?act=test&dir='+dir+'&conv='+conv+'&abbotns='+abbotns+'&abbotcustom='+abbotcustom;
		HTTP.doGet(url);
	}
