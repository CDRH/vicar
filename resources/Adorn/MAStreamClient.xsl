...
<xsl:param name="dir" />
<xsl:param name="macorpus" />
<xsl:param name="mausechoice" />
...
<head>
	...
	<script type="text/javascript" src="MAStreamClient.js">&#160;</script>
...
<body onload="MAClientInit('{$dir}','{$macorpus}','{$mausechoice}')">
